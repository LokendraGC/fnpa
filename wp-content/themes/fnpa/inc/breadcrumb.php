<?php
    if ( ! function_exists( 'fnpa_breadcrumb' ) ) {
        function fnpa_breadcrumb ( $list_style = 'ul', $list_id = '', $list_class = '', $active_class = '', $echo = false ) {
            ...
            if ( is_singular( 'post' ) ) {
                ...
                if ( $post_cats[0] ) {
                    $breadcrumb .= '<li><a href="' . get_the_permalink(32) . '">News</a></li>';
                }
            ...
            if ( is_single() && get_post_type() != 'post' && get_post_type() != 'attachment' ) {
                ...
                // Cpt title
                if( $cpt_obj->label == 'Districts ' ){
                    $id = get_the_ID();

                    $breadcrumb .= '<li><a href="'.get_the_permalink(200).'">Districts</a></li>';
                }
                 // $breadcrumb .= '<li>' . 'dfdfd' . '</li>';
                // $breadcrumb .= '<li>' . get_the_title() . '</li>';   

                // Cpt title
                if( $cpt_obj->label == 'Notices' ){
                    $id = get_the_ID();

                    $breadcrumb .= '<li><a href="'.get_the_permalink(36).'">Notices</a></li>';
                }
                ...
                if( $cpt_obj->label == 'Publications ' ){
                    $id = get_the_ID();

                    $breadcrumb .= '<li><a href="'.get_the_permalink(205).'">Publications</a></li>';
                }

                // $breadcrumb .= '<li>' . 'dfdfd' . '</li>';
                // $breadcrumb .= '<li>' . get_the_title() . '</li>';      

                if( $cpt_obj->label == 'Galleries' ){
                    $id = get_the_ID();

                    $breadcrumb .= '<li><a href="'.get_the_permalink(41).'">Gallery</a></li>';
                }
